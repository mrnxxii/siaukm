      ...
      <section class="content">
        ...
        <?php
                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_lpjad-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_lpj" value="ACC" <?php if($data['status_lpj'] == 'ACC') {echo "checked";} ?>> ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj" value="Not ACC" <?php if($data['status_lpj'] == 'Not ACC') {echo "checked";} ?>> Not ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj" value="Not Verified" <?php if($data['status_lpj'] == 'Not Verified') {echo "checked";} ?>> Not Verified
                            </label>
                          </div>
                      </div>
                      <div class="form-group">
