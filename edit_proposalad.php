...
<div class="row">
        ...
        <?php
                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_proposalad-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_proposal" value="ACC" <?php if($data['status_proposal'] == 'ACC') {echo "checked";} ?>> ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_proposal" value="Not ACC" <?php if($data['status_proposal'] == 'Not ACC') {echo "checked";} ?>> Not ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_proposal" value="Not Verified" <?php if($data['status_proposal'] == 'Not Verified') {echo "checked";} ?>> Not Verified
                            </label>
                          </div>
                      </div>
                      <div class="form-group">
                          <label class="control-label">Komentar:</label>
                          <input type="text" class="form-control" name="komentar" value="<?php echo $data['komentar'] ?>" required>
                      </div>
