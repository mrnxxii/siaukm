...
//cek level user
if($_SESSION['user_role']!="KA.SUBBAK"){
...
<div class="row">
        ...
        <?php
                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_proposalad2-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_proposal2" value="ACC" <?php if($data['status_proposal2'] == 'ACC') {echo "checked";} ?>> ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_proposal2" value="Not ACC" <?php if($data['status_proposal2'] == 'Not ACC') {echo "checked";} ?>> Not ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_proposal2" value="Not Verified" <?php if($data['status_proposal2'] == 'Not Verified') {echo "checked";} ?>> Not Verified
                            </label>
                          </div>
                      </div>
