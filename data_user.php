      ...
      <section class="content">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <a href="input_user.php"><button class="btn btn-primary">ADD</button></a><br></br>
                ...
                <tbody>
                  ...
                  while($data = mysqli_fetch_array($query)): ?>
                        <tr>
                            ...
                            <td>
                              <a class="btn btn-xs btn-success" href="edit_user.php?id=<?php echo $data['id']; ?>">Ubah Profil</a>
							   <a class="btn btn-xs btn-success" href="edit_pass.php?id=<?php echo $data['id']; ?>">Ubah Password</a>
                 <a href="hapus_user.php?id=<?php echo $data['id'];?>" onClick='return confirm("Apakah Ada yakin menghapus?")'><button class="btn btn-xs btn-danger">Hapus</button></a>
              ...
              <div class="form-group">
                 <a href="exel-user.php"><button class="btn btn-primary">Export Data ke Excel</button></a>
             </div>
            </div>
            </from>
            <!-- /.box-body -->
