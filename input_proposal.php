    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <form action="input_proposal-proses.php" enctype="multipart/form-data" role="form" method="POST">
              ...
              <div class="form-group">
                  ...
                  <input type="file" class="form-control col-md-3" name="input_proposal" accept="file/*" required>
              </div>
            <div class="form-group">
                <input type="hidden" class="form-control" name="status_proposal" value="Not Verified">
            </div>
            <div class="form-group">
                <input type="hidden" class="form-control" name="status_proposal2" value="Not Verified">
            </div>
            <div class="form-group">
                <input type="hidden" class="form-control" name="status_proposal3" value="Not Verified">
            </div>
            <div class="form-group">
                <input type="hidden" class="form-control" name="status_proposal4" value="Not Verified">
            </div>
            <div class="form-group">
