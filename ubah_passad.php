...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="data_proposalad.php.html"><i class="fa fa-circle-o"></i> Data Proposal</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Masukan Password Lama dan Password Baru
      </h1>
    </section>
          ...
          <div class="panel-body">
            ...
            <form action="ubah_pass_proses.php" method="post">
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="passkonf" placeholder="konfirmasi Password Baru">
              </div>
