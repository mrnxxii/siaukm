      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Form Tambah Berita</div>
            <div class="panel-body">
              <div class="col-md-12">
                <form action="input_berita_proses.php" enctype="multipart/form-data" role="form" method="POST">
                  ...
                  <div class="form-group">
        					...
        					<div class="form-group">
        							...
        							<textarea rows="15" class="form-control" name="isi_berita" placeholder="Masukan Berita disini...." required></textarea>
        					</div>
        					<div class="form-group">
        							<label class="control-label">Gambar:</label>
        							<input type="file" class="form-control col-md-3" name="gambar" accept="image/*" required>
                  </div>
