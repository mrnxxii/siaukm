      ...
      <section class="content">
        ...
        <?php
                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_lpjad3-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_lpj3" value="ACC" <?php if($data['status_lpj3'] == 'ACC') {echo "checked";} ?>> ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj3" value="Not ACC" <?php if($data['status_lpj3'] == 'Not ACC') {echo "checked";} ?>> Not ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj3" value="Not Verified" <?php if($data['status_lpj3'] == 'Not Verified') {echo "checked";} ?>> Not Verified
                            </label>
                          </div>
                      </div>
                      <br>
