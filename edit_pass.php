    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Data Proposal</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <section class="content-header">
      <h2>Edit Data User</h2>
            ...
            <div class="panel-body">
              ...
              <form action="edit_pass-proses.php" method="post">
                ...
                <div class="form-group">
      							...
      							<input type="password" class="form-control" name="password" placeholder="Masukan Password Baru" maxlength="16" required>
      					</div>
      					<div class="form-group">
      							<label class="control-label">Konfirm Password:</label>
      							<input type="password" class="form-control" name="password2" placeholder="Konfirm Password Baru" maxlength="16" required>
      					</div>
