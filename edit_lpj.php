                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_lpj-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_lpj" value="ACC" <?php if($data['status_lpj'] == 'ACC') {echo "checked";} ?> disabled> ACC
							  <input type="hidden" name="status_proposal" value="ACC" <?php if($data['status_lpj'] == 'ACC') {echo "checked";} ?>>
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj" value="Not ACC" <?php if($data['status_lpj'] == 'Not ACC') {echo "checked";} ?> disabled> Not ACC
							  <input type="hidden" name="status_lpj" value="Not ACC" <?php if($data['status_lpj'] == 'Not ACC') {echo "checked";} ?>>
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj" value="Not Verified" <?php if($data['status_lpj'] == 'Not Verified') {echo "checked";} ?> disabled> Not Verified
							  <input type="hidden" name="status_lpj" value="Not Verified" <?php if($data['status_lpj'] == 'Not Verified') {echo "checked";} ?>>
                            </label>
                          </div>
                      </div>
