      ...
      <section class="content">
        ...
        <?php
                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_lpjad2-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_lpj2" value="ACC" <?php if($data['status_lpj2'] == 'ACC') {echo "checked";} ?>> ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj2" value="Not ACC" <?php if($data['status_lpj2'] == 'Not ACC') {echo "checked";} ?>> Not ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_lpj2" value="Not Verified" <?php if($data['status_lpj2'] == 'Not Verified') {echo "checked";} ?>> Not Verified
                            </label>
                          </div>
                      </div>
