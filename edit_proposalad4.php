...
<div class="row">
        ...
        <?php
                  ...
                  <div class="panel-body">
                    ...
                    <form action="edit_proposalad4-proses.php" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <label>
                              <input type="radio" name="status_proposal4" value="ACC" <?php if($data['status_proposal4'] == 'ACC') {echo "checked";} ?>> ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_proposal4" value="Not ACC" <?php if($data['status_proposal4'] == 'Not ACC') {echo "checked";} ?>> Not ACC
                            </label>
                          </div>
                          <div>
                            <label>
                              <input type="radio" name="status_proposal4" value="Not Verified" <?php if($data['status_proposal4'] == 'Not Verified') {echo "checked";} ?>> Not Verified
                            </label>
                          </div>
                      </div>
